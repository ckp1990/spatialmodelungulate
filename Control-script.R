...
sb1<-c("tr.no","CHTpalplants.m2","thabitat.disturb.km")
...
### Process data ###
source('/ungulate/DataMatrix.R')
### model definition ###
Ngrid=length(modelpoly)
...
source('/ungulate/NimModUniPrior.R')
...
source('/ungulate/posteriorSummariesWITHdetectionPlot.R')
...
source('/ungulate/cell_abundance.R')
save.image()